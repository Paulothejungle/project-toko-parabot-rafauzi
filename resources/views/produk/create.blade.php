...
<div style="margin-bottom:24px;">
  ...
  <p style="font-size:13px; color:#4a4c6a; margin-top:3px;">Lengkapi informasi produk baru</p>
</div>

<form method="POST" action="/produk" enctype="multipart/form-data" id="produkForm" novalidate>
@csrf
      ...
      <div class="card-body">
        ...
        <div class="two-col">
          ...
          <div class="field-group">
            ...
            <input type="number" name="stok" id="stokInput"
              value="{{ old('stok') }}" placeholder="0" min="0"
        ...
        <div class="field-group" style="margin-bottom:0;">
          ...
          <textarea name="deskripsi" rows="3"
            class="field-input" placeholder="Deskripsi singkat produk..."
            style="resize:none; line-height:1.6;">{{ old('deskripsi') }}</textarea>
        </div>
        ...
        <div class="upload-zone" id="uploadZone">
          ...
          <div id="uploadPrompt">
            ...
            <div style="font-size:13px; color:#6e70a0;">
              Klik atau <span style="color:#a5b4fc;">drag & drop</span> foto
            </div>
          ...
          <div class="preview-wrap" id="previewWrap">
            ...
            <span class="preview-remove" onclick="removeFile(event)">✕ Hapus foto</span>
          </div>
        </div>
      </div>
    ...
    <div class="form-card" style="position:sticky; top:80px;">
      ...
      <div class="card-body">
        ...
        <div class="summary-row">
          ...
          <span class="summary-val empty" id="sum-nama">Belum diisi</span>
        </div>
        <div class="summary-row">
          <span class="summary-label">Kategori</span>
          <span class="summary-val empty" id="sum-kat">—</span>
        </div>
        <div class="summary-row">
          <span class="summary-label">Harga</span>
          <span class="summary-val empty" id="sum-harga">—</span>
        </div>
        <div class="summary-row">
          <span class="summary-label">Stok</span>
          <span class="summary-val empty" id="sum-stok">—</span>
        </div>
...
<script>
  ...
  // Init dari old() values jika ada validasi error
